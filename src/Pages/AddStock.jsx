        ...
        <div className="card-body">
          <fieldset className="fieldset grid grid-cols-2 gap-6">
           ...
           <input type="date" className="input w-full" placeholder="Date" />
            ...
            <input type="number" className="input w-full" placeholder="Trade Code" />
            </div>
            {/* high */}
            <div>
            <label className="fieldset-label">High</label>
            <input type="number" className="input w-full" placeholder="High" />
            </div>
            {/* low */}
            <div>
            <label className="fieldset-label">Low</label>
            <input type="number" className="input w-full" placeholder="Low" />
            </div>
            {/* open */}
            <div>
            <label className="fieldset-label">Open</label>
            <input type="number" className="input w-full" placeholder="Open" />
            </div>
            {/* close */}
            <div>
            <label className="fieldset-label">Close</label>
            <input type="number" className="input w-full" placeholder="Close" />
            </div>
            {/* volume */}
            <div>
            <label className="fieldset-label">Volume</label>
            <input type="text" className="input w-full" placeholder="Volume" />
            </div>
